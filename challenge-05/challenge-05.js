...
*/
console.log('O "livro Anjos e Demonios" tem ' + book('Anjos e Demonios').quantidadedePaginas + ' páginas!');
...
*/
console.log('O autor do livro "Anjos e Demonios" é ' + book('Anjos e Demonios').autor + '.');
...
*/
console.log('O livro "O Simbolo Perdido" foi publicado pela editora '+ book('O Simbolo Perdido').editora + '.');
